  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        //     child: CustomAppbarProfile(title: "Supermarkets", icon: Icons.arrow_back_ios, ontap: () => Navigator.of(context).pop()),
        //   ),
        // ),
        body: Padding(
          ...
          child: Column(
            children: [
              CustomAppbarProfile(title: "Supermarkets", icon: Icons.arrow_back_ios, ontap: () => Navigator.of(context).pop()),
              Expanded(
