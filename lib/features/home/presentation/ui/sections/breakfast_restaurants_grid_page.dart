...
class BreakfastRestaurantsGridPage extends StatelessWidget {
  final List<HomeRestaurantModel> restaurants;

  const BreakfastRestaurantsGridPage({super.key, required this.restaurants});
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Padding(
            ...
            child: CustomAppbarProfile(title: "Breakfast", icon: Icons.arrow_back_ios, ontap: () => Navigator.of(context).pop()),
          ),
        ),
        body: Padding(
