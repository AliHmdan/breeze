      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 15.sp, fontWeight: FontWeight.w600),
          ),
          ...
          Row(
            children: [
              ...
              SizedBox(width: 4.w),
              CustomSubTitle(subtitle: feeText, color: Theme.of(context).colorScheme.onSurface, fontsize: 11.sp),
            ],
          ),
        ],
      ),
