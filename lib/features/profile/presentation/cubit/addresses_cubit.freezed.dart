...
mixin _$AddressesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ProfileAddress> items, int? selectedId,
            String? toast, bool isRefreshing, Set<int> deletingIds)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ProfileAddress> items, int? selectedId,
            String? toast, bool isRefreshing, Set<int> deletingIds)?
        loaded,
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function()? initial,
    TResult Function()? loading,
    TResult Function(List<ProfileAddress> items, int? selectedId, String? toast,
            bool isRefreshing, Set<int> deletingIds)?
        loaded,
    TResult Function(String message)? error,
...
class __$$LoadedImplCopyWithImpl<$Res>
    extends _$AddressesStateCopyWithImpl<$Res, _$LoadedImpl>
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<ProfileAddress> items,
      this.selectedId,
      this.toast,
      this.isRefreshing = false,
      final Set<int> deletingIds = const <int>{}})
      : _items = items,
        _deletingIds = deletingIds;

  final List<ProfileAddress> _items;
  @override
  List<ProfileAddress> get items {
  ...
  @override
  String toString() {
    return 'AddressesState.loaded(items: $items, selectedId: $selectedId, toast: $toast, isRefreshing: $isRefreshing, deletingIds: $deletingIds)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(items, selectedId, toast, isRefreshing, deletingIds);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(items, selectedId, toast, isRefreshing, deletingIds);
  }
...
abstract class _Loaded implements AddressesState {
  const factory _Loaded(
      {required final List<ProfileAddress> items,
      final int? selectedId,
      final String? toast,
      final bool isRefreshing,
      final Set<int> deletingIds}) = _$LoadedImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'AddressesState.error(message: $message)';
  }
...
abstract class _Error implements AddressesState {
